...
def load_texture(path, wrap_s=gl.GL_REPEAT, wrap_t=gl.GL_REPEAT,
    ...
    gl.glTexImage2D(gl.GL_TEXTURE_2D, 0, gl.GL_RGBA, tw, th, 0, gl.GL_RGBA, gl.GL_UNSIGNED_BYTE, raw)
    gl.glBindTexture(gl.GL_TEXTURE_2D, 0)
    return tex

def create_texture_from_surface(surf, wrap_s=gl.GL_CLAMP, wrap_t=gl.GL_CLAMP,
                                min_filter=gl.GL_LINEAR, mag_filter=gl.GL_LINEAR):
    """
